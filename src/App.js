...
const data = [
    ...
    },
    {
      ...
      data: {
        ...
        path:
          "/Music/Johann Pachelbel - Canon In D (Piano and Violin Duet).mp3",
    ...
    },
    {
      ...
      data: {
        name:
          "Seirei no moribito - Naji no Uta, Japanese and English lyrics.mp3",
        type: "file",
        parent: "/Music",
        size: 6901265,
    ...
    },
    {
      ...
      data: {
        name:
          "Itoshii Hito e (愛しい人へ; To the loved one) - Sachi Tainaka.mp3",
        type: "file",
        parent: "/Music",
        size: 9073632,
...
class FileTable extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: this.getData(this.props.parent)
        ...
        <Router>
          <div>
            ...
            <Switch>
              ...
              <Route path="/parent/:path" render={({ match }) => {
